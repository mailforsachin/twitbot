...
var arraylist=['#MyVoteForIndia','#ThoughtForTheDay', '#PeaceDay', '#WinterIsComing', '#AvengersEndGame', '#NamoAgain2019','#FirEkBaarModiSarkaar']
var arraylist1=['#ClimateStrike','#JuvenileJustice','#YouthJustice','#UCLDraw','#TeriMitti']
